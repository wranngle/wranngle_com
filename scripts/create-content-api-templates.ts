        ...
        actions: [
          {
            title: 'Dashboard',
            type: 'URL',
            url: 'https://wranngle.com/dashboard',
          },
        ...
        actions: [
          {
            title: 'View Receipt',
            type: 'URL',
            url: 'https://wranngle.com/invoices/{{2}}',
          },
  ...
  },
  {
    ...
    types: {
      ...
      'twilio/card': {
        ...
        orientation: 'HORIZONTAL',
        actions: [{title: 'Reset Password', type: 'URL', url: '{{1}}'}],
      },
    },
  },
  {
        ...
        actions: [
          {
            title: 'View Proposal',
            type: 'URL',
            url: 'https://wranngle.com/proposals',
          },
        ...
        actions: [
          {
            title: 'View Quote',
            type: 'URL',
            url: 'https://wranngle.com/quotes/{{2}}',
          },
          {
            title: 'Accept Quote',
            type: 'URL',
            url: 'https://wranngle.com/quotes/{{2}}/accept',
          },
        ],
      },
    },
            ...
            actions: [
              {
                title: 'Reactivate',
                type: 'URL',
                url: 'https://wranngle.com/reactivate',
              },
              {
                title: 'Tell Me More',
                type: 'QUICK_REPLY',
