...
## Purpose
The project is the web application and landing page for **Wranngle Systems**, an AI and automation consultancy. It features a distinct "console" aesthetic and integrates an **ElevenLabs Conversational AI** agent (`agent_xxxx_demo`). The application aims to showcase the consultancy's services and demonstrate their capabilities through the interactive AI agent.
...
- **ElevenLabs:** Used for the conversational AI agent (Agent ID: `agent_xxxx_demo`).
