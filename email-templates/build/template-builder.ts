...
export class EmailTemplateBuilder {
  ...
  private getSampleData(templateName: string): TemplateVariables {
    ...
    const samplesByTemplate: Record<string, TemplateVariables> = {
      ...
      'lead-intake': {
        EMAIL_TITLE: 'New Lead: Acme Plumbing Co',
        ...
        AGENT_NAME: 'Samantha',
        STATUS: 'PENDING',
        NOTES: 'Interested in after-hours call handling. Currently using an answering service but looking to upgrade. Has 3 technicians on staff. Peak season is summer.',
