...
6. **Cross-sell on Elite form** — A Landing Page or Web Chat suggestion now appears in the Elite Agent intake (was: only "Elite Agent Secured" badge). **Why**: peak surface for a website upsell; a buyer who just chose the $500/mo agent has demonstrated capacity.
...
- **No live testimonials/case-study row** on offerings cards — premium positioning would benefit, but the user explicitly forbade fake testimonials and there is no real social-proof corpus to pull from yet.
