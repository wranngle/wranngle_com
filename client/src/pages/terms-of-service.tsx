...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-[#12111a] text-[#fcfaf5] py-20 px-6">
      <style>{`
        :root { --v500: #cf3c69; --s500: #ff5f00; --n950: #12111a; }
        .brand-font { font-family: 'Bricolage Grotesque', sans-serif; }
      `}</style>

      <div className="max-w-4xl mx-auto">
        <Link href="/">
          <a className="inline-flex items-center gap-2 text-[var(--s500)] hover:underline mb-8">
            ← Back to Home
          </a>
        </Link>

        <h1 className="brand-font text-5xl font-bold mb-4">Terms of Service</h1>
        ...
        <div className="space-y-8 leading-relaxed">
          <section>
            ...
            <p className="opacity-80">
              ...
              who have purchased AI voice agent subscriptions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              ...
              handle inbound calls for trades businesses. The Service includes:
            </p>
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              <strong>Core Agent ($250/month):</strong> Includes voice-only AI
              agent with 1,000 voice minutes and 500 SMS segments per month.
            </p>
            <p className="opacity-80 mb-4">
              <strong>Elite Agent ($500/month):</strong> Includes triple-channel
              voice + web + SMS AI agents with 2,500 voice minutes and 1,500 SMS
              segments per month.
            </p>
            <p className="opacity-80 mb-4">
              Subscriptions are billed monthly in advance. Annual subscriptions
              receive a discount (15% for Core, 20% for Elite) and require
              12-month commitment.
            </p>
            <p className="opacity-80">
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              Each plan includes monthly usage limits. Usage beyond these limits
              will be billed at standard overage rates:
            </p>
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
            ...
            <p className="opacity-80 mt-4">
              You will receive usage alerts when approaching your plan limits.
              Overage charges are billed in arrears on your next invoice.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              Monthly subscriptions may be cancelled at any time, effective at
              the end of the current billing period. No refunds are provided for
              partial months.
            </p>
            <p className="opacity-80 mb-4">
              Annual subscriptions may be cancelled with a cancellation fee
              equal to 50% of remaining months. For example, cancelling 6 months
              into an annual contract incurs a fee of 3 months&apos; service
              cost.
            </p>
            <p className="opacity-80">
              Refunds are not provided except as required by law or at our sole
              discretion.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              ...
              but not limited to text, graphics, logos, software, and AI models,
              are the exclusive property of Wranngle Systems and are protected
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              ...
              including call recordings and transcripts. We process this data
              solely to provide the Service.
            </p>
            <p className="opacity-80">
              You are responsible for ensuring you have proper consent and
              authorization to record and process calls in your jurisdiction.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              We strive to maintain 99.5% uptime for the Service. However, we do
              not guarantee uninterrupted access and are not liable for downtime
              due to:
            </p>
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              To the fullest extent permitted by law, Wranngle Systems shall not
          ...
          <section>
            ...
            <p className="opacity-80">
              ...
              meet your specific requirements. AI-generated responses may
              occasionally be inaccurate or inappropriate, and you should review
              and monitor agent interactions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-80">
              You agree to indemnify, defend, and hold harmless Wranngle Systems
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              ...
              time, with or without cause, with or without notice. Grounds for
              termination include:
            </p>
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
            ...
            <p className="opacity-80 mt-4">
              Upon termination, you must immediately cease using the Service. We
              may delete your data in accordance with our data retention
              policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-80">
              ...
              injunctive relief in court for intellectual property violations or
              unauthorized access.
            </p>
          </section>
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <Link href="/">
            <a className="inline-flex items-center gap-2 text-[var(--s500)] hover:underline">
              ← Back to Home
            </a>
          </Link>
        </div>
