  ...
  return (
    <div className="min-h-screen bg-[#12111a] text-[#fcfaf5] py-20 px-6">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="brand-font text-5xl font-bold mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-8 leading-relaxed">
          <section>
            ...
            <p className="opacity-80 mb-4">
              ...
              disclose, and safeguard your information when you use our AI voice
          ...
          <section>
            ...
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
              <li>
                <strong>Account Information:</strong> Business name, industry,
              ...
              <li>
                ...
                preferences, knowledge base content, business-specific settings
              </li>
              <li>
                <strong>Support Communications:</strong> Messages, feedback, and
            ...
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
              <li>
                <strong>Call Data:</strong> Phone numbers, call duration, call
                timestamps, call recordings, and AI-generated transcripts
              </li>
              <li>
            ...
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
              ...
              <li>
                <strong>Twilio:</strong> Telephony metadata and delivery status
              </li>
              <li>
                <strong>Stripe:</strong> Payment status and subscription details
              </li>
              <li>
                <strong>Cal.com:</strong> Calendar appointment data (Elite tier
                only)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
              <li>
                <strong>Provide the Service:</strong> Create and manage AI voice
                agents, process calls, send SMS messages
              </li>
              <li>
                <strong>Billing and Payments:</strong> Process subscriptions,
                calculate usage charges, send invoices
              </li>
              <li>
                <strong>Improve the Service:</strong> Analyze usage patterns,
                optimize AI performance, develop new features
              </li>
              <li>
              ...
              <li>
                <strong>Communications:</strong> Send service updates, billing
                notifications, and marketing messages (with your consent)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="opacity-80 mb-4">
              Our Service records and transcribes calls handled by AI agents.
            ...
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
              <li>
                You are responsible for complying with call recording laws in
                your jurisdiction
              </li>
              <li>
              ...
              <li>
                You must obtain necessary consents from callers before using the
                Service
              </li>
            </ul>
          ...
          <section>
            ...
            <p className="opacity-80 mt-4">
              You may request earlier deletion of certain data types, subject to
          ...
          <section>
            ...
            <p className="opacity-80 mt-4">
              To exercise these rights, contact us at privacy@wranngle.com. We
          ...
          <section>
            ...
            <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
              ...
              <li>
                <strong>Performance Cookies:</strong> To optimize loading times
                and functionality
              </li>
            </ul>
            <p className="opacity-80 mt-4">
          ...
          <section>
            ...
            <p className="opacity-80 text-sm">
              For European users, our GDPR representative can be contacted at
              gdpr@wranngle.com
            </p>
          </section>
        </div>
