/* eslint-disable complexity, no-bitwise, no-return-assign, unicorn/prefer-math-trunc, @typescript-eslint/no-restricted-types, @typescript-eslint/restrict-plus-operands, @typescript-eslint/switch-exhaustiveness-check -- vendored ElevenLabs UI registry component; shader animation math intentionally uses compact bitwise PRNG and broad uniform types. */
'use client';
